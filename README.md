[README(1).md](https://github.com/user-attachments/files/26744561/README.1.md)
...
You can compare two simulations side-by-side, retrieve all historical runs from the database, or just query a country's environmental profile on its own.
...
### `GET /compare_sims/{id1}/{id2}`
Fetches two simulation results by ID for side-by-side comparison.

**Example:** `GET /compare_sims/1/2`
...
| API | Usage |
|---|---|
| [OpenWeatherMap](https://openweathermap.org/api) | Temperature, humidity, air quality index |
| [REST Countries](https://restcountries.com) | Population, land area, coordinates |
